...
try:
    ...
    try: # GAIACODE
        ...
        def to_utf8(v): # GAIACODE
            return v # GAIACODE
        def print_(*args, **kwargs): # GAIACODE
            pass # GAIACODE
else:
    del __builtin__
...
def build_user_agent():
    ...
    try: operatingSystem = platform.platform()
    except: operatingSystem = 'Linux'
    try: architecture = platform.architecture()[0]
    except: architecture = 'x86_64'
    ua_tuple = (
        'Mozilla/5.0',
        '(%s; U; %s; en-us)' % (operatingSystem,
                                architecture),
        'Python/%s' % platform.python_version(),
        '(KHTML, like Gecko)',
        'speedtest-cli/%s' % __version__
...
class Speedtest(object):
    ...
    def get_config(self):
        ...
        except: ignore_servers = [] # GAIACODE
