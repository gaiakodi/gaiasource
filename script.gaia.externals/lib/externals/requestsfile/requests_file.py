from externals.requests.adapters import BaseAdapter
from externals.requests.compat import urlparse, unquote
from externals.requests import Response, codes
import errno
import os
import stat
import locale
