...
class MultipartEncoder(object):
    ...
    .. code-block:: python
        ...
        import externals.requests as requests
        from externals.requests_toolbelt import MultipartEncoder
...
class MultipartEncoderMonitor(object):
    ...
    .. code-block:: python
        ...
        from externals.requests_toolbelt import MultipartEncoderMonitor
        import externals.requests as requests
...
class FileFromURLWrapper(object):
    ...
    .. code-block:: python
        ...
        import externals.requests as requests
        from externals.requests_toolbelt import MultipartEncoder, FileFromURLWrapper
