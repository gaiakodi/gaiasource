...
class X509Adapter(HTTPAdapter):
    ...
    Usage::
      ...
      >>> import externals.requests as requests
      >>> from externals.requests_toolbelt.adapters.x509 import X509Adapter
      >>> s = requests.Session()
    ...
    def _import_pyopensslcontext(self):
        ...
        if requests.__build__ < 0x021200:
            ...
            try:
                from externals.requests.packages.urllib3.contrib.pyopenssl \
                        import PyOpenSSLContext
            except ImportError:
                try:
                    from externals.urllib3.contrib.pyopenssl import PyOpenSSLContext
                except ImportError:
                    PyOpenSSLContext = None
