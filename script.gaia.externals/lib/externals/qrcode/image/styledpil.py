...
from externals.qrcode.image.styles.colormasks import QRColorMask, SolidFillColorMask
from externals.qrcode.image.styles.moduledrawers import SquareModuleDrawer


class StyledPilImage(externals.qrcode.image.base.BaseImageWithDrawer):
    """
