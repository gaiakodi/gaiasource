...
from externals.qrcode.compat.etree import ET
from externals.qrcode.image.styles.moduledrawers import svg as svg_drawers
from externals.qrcode.image.styles.moduledrawers.base import QRModuleDrawer
