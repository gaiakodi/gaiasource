...
from externals.qrcode import constants, exceptions, util
from externals.qrcode.image.base import BaseImage
from externals.qrcode.image.pure import PyPNGImage
    ...
    def make_image(self, image_factory=None, **kwargs):
        ...
        if image_factory is not None:
            ...
            if image_factory is None:
                from externals.qrcode.image.pil import Image, PilImage
