...
import warnings
from externals.beautifulsoup._typing import _NamespaceMapping

if TYPE_CHECKING:
    from externals.soupsieve import SoupSieve
    from externals.beautifulsoup import element
    from externals.beautifulsoup.element import ResultSet, Tag

soupsieve: Optional[ModuleType]
try:
    from externals import soupsieve
except ImportError:
    soupsieve = None
    warnings.warn(
...
class CSS(object):
    ...
    def _rs(self, results: MutableSequence[Tag]) -> ResultSet[Tag]:
        ...
        from externals.beautifulsoup import ResultSet
