...
from externals.typingextensions import TypeAlias
from externals.beautifulsoup.dammit import EntitySubstitution

if TYPE_CHECKING:
    from externals.beautifulsoup._typing import _AttributeValue
...
class Formatter(EntitySubstitution):
    ...
    like `externals.beautifulsoup.element.Tag.encode`. Most people won't need to
    ...
    def __init__(
        ...
        :param entity_substitution: A function to call to replace special
           ...
           externals.beautifulsoup.dammit.EntitySubstitution.substitute_html and substitute_xml.
    ...
    def attributes(
        self, tag: externals.beautifulsoup.element.Tag # type:ignore
