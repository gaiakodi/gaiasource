...
documentation: http://www.crummy.com/software/BeautifulSoup/externals.beautifulsoup.doc/
"""
...
from externals.beautifulsoup.exceptions import (
    FeatureNotFound,
    ParserRejectedMarkup,
    StopParsing,
)
from externals.beautifulsoup._warnings import (
    AttributeResemblesVariableWarning,
    GuessedAtParserWarning,
    MarkupResemblesLocatorWarning,
    UnusualUsageWarning,
...
# Aliases to make it easier to get started quickly, e.g. 'from externals.beautifulsoup import _soup'
_s = BeautifulSoup
_soup = BeautifulSoup
