...
import warnings
import sys
from externals.beautifulsoup.element import (
    AttributeDict,
    AttributeValueList,
...
from externals.beautifulsoup.exceptions import ParserRejectedMarkup
...
from externals.beautifulsoup._warnings import XMLParsedAsHTMLWarning
...
class TreeBuilder(object):
    ...
    :param multi_valued_attributes: If this is set to None, the
     ...
     customize this behavior; look at :py:attr:`externals.beautifulsoup.builder.HTMLTreeBuilder.DEFAULT_CDATA_LIST_ATTRIBUTES`
     for an example.
    ...
    :param store_line_numbers: If the parser keeps track of the line
     ...
     :py:class:`externals.beautifulsoup.element.Tag` object. You can turn this off by
    ...
    #: instantiated with some class other than `externals.beautifulsoup.element.NavigableString`.
    DEFAULT_STRING_CONTAINERS: Dict[str, Type[externals.beautifulsoup.element.NavigableString]] = {} # type:ignore
...
class HTMLTreeBuilder(TreeBuilder):
    ...
    #: represented by a string class other than `externals.beautifulsoup.element.NavigableString`.
    #:
