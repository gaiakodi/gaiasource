...
from externals.beautifulsoup.dammit import EntitySubstitution, UnicodeDammit

from externals.beautifulsoup.builder import (
...
if TYPE_CHECKING:
    ...
    from externals.beautifulsoup.element import NavigableString
...
class HTMLParserTreeBuilder(HTMLTreeBuilder):
    """A Beautiful soup `externals.beautifulsoup.builder.TreeBuilder` that uses the
