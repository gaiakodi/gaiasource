...
from externals.beautifulsoup.css import CSS
from externals.beautifulsoup._deprecation import (
    _deprecated,
    _deprecated_alias,
    _deprecated_function_alias,
)
from externals.beautifulsoup.formatter import (
    Formatter,
    HTMLFormatter,
    XMLFormatter,
)
from externals.beautifulsoup._warnings import AttributeResemblesVariableWarning
...
from externals.typingextensions import (
    Self,
    TypeAlias,
)
...
if TYPE_CHECKING:
    ...
    from externals.beautifulsoup.builder import TreeBuilder
    from externals.beautifulsoup.filter import ElementFilter
    from externals.beautifulsoup.formatter import (
        _EntitySubstitutionFunction,
        _FormatterOrName,
    )
    from externals.beautifulsoup._typing import (
        _AtMostOneElement,
        _AtMostOneTag,
...
class PageElement(object):
    ...
    def formatter_for_name(
        ...
        :param formatter: Can be a `Formatter` object (used as-is), a
            ...
            `externals.beautifulsoup.formatter.XMLFormatter` or
            `externals.beautifulsoup.formatter.HTMLFormatter`), or a string (used to look
            up an `externals.beautifulsoup.formatter.XMLFormatter` or
            `externals.beautifulsoup.formatter.HTMLFormatter` in the appropriate registry.
...
# externals.beautifulsoup.element.SoupStrainer.
from externals.beautifulsoup.filter import SoupStrainer # noqa: E402
