...
class PageElement(object):
    ...
    def find_next(self, name=None, attrs={}, string=None, **kwargs):
        ...
        :rtype: externals.beautifulsoup.element.Tag | externals.beautifulsoup.element.NavigableString
        """
    ...
    def find_next_siblings(self, name=None, attrs={}, string=None, limit=None,
        ...
        :rtype: externals.beautifulsoup.element.ResultSet
        """
        _stacklevel = kwargs.pop('_stacklevel', 2)
...
class Tag(PageElement):
    ...
    def select_one(self, selector, namespaces=None, **kwargs):
        ...
        :return: A Tag.
        :rtype: externals.beautifulsoup.element.Tag
        """
