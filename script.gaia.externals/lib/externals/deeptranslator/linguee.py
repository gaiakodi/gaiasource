...
from externals.deeptranslator.constants import BASE_URLS, LINGUEE_LANGUAGES_TO_CODES
from externals.deeptranslator.exceptions import (
...
from externals.deeptranslator.validate import is_empty, is_input_valid
