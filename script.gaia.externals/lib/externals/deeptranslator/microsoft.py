...
from externals.deeptranslator.constants import BASE_URLS, MSFT_ENV_VAR
from externals.deeptranslator.exceptions import ApiKeyException, MicrosoftAPIerror
from externals.deeptranslator.validate import is_input_valid
