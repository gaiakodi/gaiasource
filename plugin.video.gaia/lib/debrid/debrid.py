	...
	def providers(self):
		return [
			...
			},
			{
				'id' : 'torbox',
				'name' : 35606,
				'description' : 'TorBox is an overall good service and has great value for money. TorBox is a relatively new services, but is packed with features. Although not natively supported in Gaia, most functionality can be utilized through external addons. TorBox is good choice if you are on a budget and want a service with a decent cache.',
			...
			},
			{
				'id' : 'easydebrid',
				'name' : 36024,
				'description' : 'EasyDebrid is an overall good service and has great value for money. EasyDebrid is a relatively new services that only supports cached torrents. Adding uncached content is not supported, but most titles should be available in their huge cache. Although not natively supported in Gaia, most functionality can be utilized through Orion. EasyDebrid is good choice if you are on a budget and want a service with a decent cache.',

				'general' : {'rating' : 4,  'recommend' : 2, 'native' : False, 'limit' : False},
				'subscription' : {'rating' : 5, 'fee' : 3.50},
				'customer' : {'rating' : 4, 'label' : 36247},
				'api' : {'rating' : 4, 'label' : 36244},
				'network' : {'rating' : 3, 'support' : {'torrent' : True, 'usenet' : False, 'hoster' : False}},
				'stream' : {'rating' : 3, 'support' : {'gaia' : False, 'orion' : True, 'resolver' : False}},
				'cache' : {'rating' : 5, 'label' : 36250, 'support' : {'gaia' : False, 'orion' : True, 'resolver' : False}},
				'select' : {'rating' : 4, 'support' : {'gaia' : False, 'orion' : True, 'resolver' : False}},
				'extra' : {'rating' : 0, 'support' : {'gaia' : False, 'orion' : False, 'resolver' : False}},
